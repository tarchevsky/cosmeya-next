				...
				<main className='prose max-w-none'>
					...
					<section className='mb-12'>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
							<div>
								<p className='text-lg leading-relaxed'>
									Мы всегда в курсе новых тенденций и предлагаем
									профессиональный подход к новогоднему праздничному оформлению.
									Наши дизайнеры создадут для вас настоящую сказку! В сжатые
									сроки мы предложим реалистичные визуализации, чтобы вы могли
									увидеть будущий праздничный декор.
								</p>
							</div>
							<div>
								<p className='text-lg leading-relaxed'>
									Мы можем предложить новогоднее оформление в разных стилях и
									цветах. Выполним интерьерный, фасадный и уличный декор в одной
									концепции или предложим разные варианты. Широкий взгляд,
									модные тенденции, качественные материалы и учет принципов
									Фэн-Шуй.
								</p>
							</div>
						</div>
